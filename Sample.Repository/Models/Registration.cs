...
namespace Sample.Repository.Models
{
    public partial class Registration
    {
        ...
        public string EnrolInterviewCondInd { get; set; }
        public string DocumentedPlspRequiredInd { get; set; }
        public string ConsultationParentsCondInd { get; set; }
        public string EmergencyResponsePlanInd { get; set; }
        public string DocumentedPlspInd { get; set; }
        public string CommunicationDocmentPlanInd { get; set; }
        public string BehaviourMgmtPlanOtherInd { get; set; }
        public string IndividualHlthCarePlanInd { get; set; }
